...
public class WxPaymentController {
    ...
    public Dto createCode(@PathVariable String orderNo) {
        try {
            ...
            //异步通知的URL地址。
            //http://itripstore.free.idcfengye.com/itriptrade/api/wx/notify,   http://www.weixin.qq.com/wxpay/pay.php
            data.put("notify_url", "http://itripstore.free.idcfengye.com/itriptrade/api/wx/notify");
